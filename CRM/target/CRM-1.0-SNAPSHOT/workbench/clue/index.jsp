...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#searchBtn").click(function () {
			...
			$("#hidden-clueOwner").val($.trim($("#search-clueOwner").val()));
	...
	function pageList(pageNo,pageSize) {
		...
		$("#search-clueOwner").val($.trim($("#hidden-clueOwner").val()));
		...
		$.ajax({
			...
			data:{
				...
				"clueOwner" : $.trim($("#search-clueOwner").val()),
...
<body>
	...
	<input type="hidden" id="hidden-clueOwner">
